...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/validation/";
/******/ 	})();
/******/ 	
/************************************************************************/
...
// EXTERNAL MODULE: ./node_modules/creditcard.js/dist/creditcard.js
var creditcard = __webpack_require__(9425);
// EXTERNAL MODULE: ./node_modules/inputmask/dist/inputmask.js
var inputmask = __webpack_require__(5382);
var inputmask_default = /*#__PURE__*/__webpack_require__.n(inputmask);
;// CONCATENATED MODULE: ./src/assets/images/visa.png
const visa_namespaceObject = __webpack_require__.p + "87990be4d5a2b771549e.png";
;// CONCATENATED MODULE: ./src/assets/images/mastercard.png
const mastercard_namespaceObject = __webpack_require__.p + "52455888d2c3d7f8d24c.png";
;// CONCATENATED MODULE: ./src/assets/images/discover.png
const discover_namespaceObject = __webpack_require__.p + "528b02b6cc318bfc41f9.png";
;// CONCATENATED MODULE: ./src/assets/images/american-express.png
const american_express_namespaceObject = __webpack_require__.p + "bcfb7842d8c14756efef.png";
...
var validator = __webpack_require__(3999);
...
var container = el('div.container#container');
var src_form = el('form.form#form'); // создаем форму

var cardNumberLabelText = el('p.input-text', 'Введите номер карты'); // создаем инпут номера карты

var cardNumberLabel = el('label', {
  "for": 'cardNumberInput',
  id: 'cardNumberLabel',
  "class": 'form-label'
});
var cardNumberInput = el('input', {
  type: 'text',
  "class": 'form-input',
  id: 'cardNumberInput',
  autocomplete: 'off'
});
var cardTypeBox = el('div', {
  "class": 'card-type-box',
  id: 'card-type-box'
});
setChildren(cardNumberLabel, [cardNumberLabelText, cardNumberInput, cardTypeBox]);
var cardExpireLabelText = el('p.input-text', 'Введите дату окончания действия карты (ММ/ГГ)'); // создаем инпут даты окончания

var cardExpireLabel = el('label', {
  "for": 'cardExpireInput',
  id: 'cardExpireLabel',
  "class": 'form-label'
});
var cardExpireInput = el('input', {
  type: 'text',
  "class": 'form-input',
  id: 'cardExpireInput',
  autocomplete: 'off'
});
setChildren(cardExpireLabel, [cardExpireLabelText, cardExpireInput]);
var cardCVCLabelText = el('p.input-text', 'Введите CVC/CVV (3 цифры на обороте карты)'); // создаем инпут CVC

var cardCVCLabel = el('label', {
  "for": 'cardCVCInput',
  id: 'cardCVCLabel',
  "class": 'form-label'
});
var cardCVCInput = el('input', {
  type: 'text',
  "class": 'form-input',
  id: 'cardCVCInput',
  autocomplete: 'off'
});
setChildren(cardCVCLabel, [cardCVCLabelText, cardCVCInput]);
var emailLabelText = el('p.input-text', 'Введите email для отправки онлайн-чека'); // создаем инпут email
...
setChildren(emailLabel, [emailLabelText, emailInput]);
var formButton = el('button', 'Оплатить', {
  id: 'form-button',
  "class": 'form-button',
  disabled: 'disabled'
});
...
setChildren(src_form, [cardNumberLabel, cardExpireLabel, cardCVCLabel, emailLabel, formButton]);
setChildren(container, src_form);
setChildren(window.document.body, container); // валидация формы
...
function validateAll() {
  cardNumber = cardNumberInput.value.replace(/[\s_]/g, '');
  cardExpireDate = cardExpireInput.value;
  cardExpireMonth = cardExpireDate.slice(0, 2);
  cardExpireYear = cardExpireDate.slice(3);
  cardCVC = cardCVCInput.value;
  email = emailInput.value.trim(); // eslint-disable-next-line max-len

  if ((0,creditcard.isValid)(cardNumber) && (0,creditcard.isExpirationDateValid)(cardExpireMonth, cardExpireYear) && (0,creditcard.isSecurityCodeValid)(cardNumber, cardCVC) && validator.validate(email)) {
  ...
  cardType = type(cardNumber);

  if (cardType === 'Master') {
    cardTypeBox.style.backgroundImage = "URL(".concat(mastercard_namespaceObject, ")");
  } else if (cardType === 'Visa') {
    cardTypeBox.style.backgroundImage = "URL(".concat(visa_namespaceObject, ")");
  } else if (cardType === 'Amex') {
    cardTypeBox.style.backgroundImage = "URL(".concat(american_express_namespaceObject, ")");
  } else if (cardType === 'Discover') {
    cardTypeBox.style.backgroundImage = "URL(".concat(discover_namespaceObject, ")");
  } else {
    cardTypeBox.style.backgroundImage = 'none';
  }
}
...
cardNumberInput.addEventListener('blur', function () {
  ...
  if ((0,creditcard.isValid)(cardNumber)) {
...
cardExpireInput.addEventListener('blur', function () {
  cardExpireDate = cardExpireInput.value;
  cardExpireMonth = cardExpireDate.slice(0, 2);
  cardExpireYear = cardExpireDate.slice(3);

  if ((0,creditcard.isExpirationDateValid)(cardExpireMonth, cardExpireYear)) {
    cardExpireInput.style.color = 'black';
  } else {
    cardExpireInput.style.color = 'red';
  }
});
...
cardCVCInput.addEventListener('blur', function () {
  ...
  if ((0,creditcard.isSecurityCodeValid)(cardNumber, cardCVC)) {
    cardCVCInput.style.color = 'black';
  } else {
    cardCVCInput.style.color = 'red';
  }
});
...
var cardNumberMask = new (inputmask_default())('9999 9999 9999 9999[ 9999]');
cardNumberMask.mask(cardNumberInput);
var cardExpireMask = new (inputmask_default())('99/99');
cardExpireMask.mask(cardExpireInput);
var CVCMask = new (inputmask_default())('999');
CVCMask.mask(cardCVCInput);
})();
